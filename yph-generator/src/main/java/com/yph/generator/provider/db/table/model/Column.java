package com.yph.generator.provider.db.table.model;


import java.util.List;

import com.yph.generator.GeneratorProperties;
import com.yph.generator.provider.db.SqlReservedWords;
import com.yph.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.yph.generator.provider.db.table.model.util.ColumnHelper;
import com.yph.generator.util.GLogger;
import com.yph.generator.util.StringHelper;
import com.yph.generator.util.TestDataGenerator;
import com.yph.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.yph.generator.util.typemapping.DatabaseDataTypesUtils;
import com.yph.generator.util.typemapping.JavaPrimitiveTypeMapping;
import com.yph.generator.util.typemapping.JdbcType;
