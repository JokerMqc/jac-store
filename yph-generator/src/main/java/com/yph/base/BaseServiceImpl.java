...
public abstract class BaseServiceImpl<T> implements IBaseService<T> {
     ...
     */
    @Override
    public PageInfo findListByPage(HashMap<String, Object> params, Integer pageNum, Integer pageSize) {
        ...
        List<T> list = getBaseMapper().findListByPage(params);
