        ...
        <form class="layui-form" action="">
            <div class="layui-form-item form-item-ex">
                <div class="layui-inline ">
                    <label class="layui-form-label form-label-ex-4">邮件名称:</label>
...
<script type="text/html" id="sendStat">
    {{# if(d.sendStatus=='0'){ }}
    <span class="layui-badge layui-bg-blue">已发送</span>
    {{# } else{ }}
    <span class="layui-badge layui-bg-cyan">发送失败</span>
    {{# }  }}
</script>

<script src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
<script src="${pageContext.request.contextPath}/js/plugins/layui/layui.js"></script>
<script src="${pageContext.request.contextPath}/js/sys/mail/sys_mail_list.js"></script>
</body>
</html>
