...
<div id="content" style="height: 100%;padding:0;margin: 0;overflow: hidden;">
        ...
        <form class="layui-form" action="">
            <div class="layui-form-item form-item-ex">
                <div class="layui-inline ">
                    <label class="layui-form-label form-label-ex-4">模板名称:</label>
                    <div class="layui-input-inline input-line-ex">
                        <input type="text" id="searchName" name="roleName" placeholder="输入模板名称搜索" autocomplete="off"
    ...
    <%--新建菜单 弹出框--%>
    <div id="editWindow" hidden="hidden" style="overflow: hidden">
            ...
            <div class="layui-field-box">
                <form id="createForm" class="layui-form" action="">
                    ...
                    <div class="layui-form-item form-item-ex">
                        <div class="layui-row">
                            <div class="layui-col-xs6">
                                ...
                                <div class="layui-input-inline form-input-line-ex">
                                    <input type="text" id="" name="namename" required autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-col-xs6">
                                <label class="layui-form-label form-label-ex-4">模板类型:</label>
                                <div class="layui-input-inline form-input-line-ex">
                                    <input type="text" id="remark" name="remark" required autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-row">
                            <div class="layui-col-xs6">
                                <label class="layui-form-label form-label-ex-4">模板主题:</label>
                                <div class="layui-input-inline form-input-line-ex">
                    ...
                    <div class="layui-form-item form-item-ex" style="text-align: center;">
                        <div class="layui-inline">
                            <div class="layui-input-inline input-line-ex line-button-ex">
                                <button class="layui-btn  layui-btn-sm" lay-submit="" lay-filter="saveSysRole">保存
                                </button>
...
<script type="text/html" id="barOption">
    {{# if(d.statusFlag=='0'){   }}
    <a class="layui-btn  layui-btn-warm layui-btn-xs" lay-event="cancel"><i class="layui-icon">&#x1007;</i>取消默认</a>
    {{# } else{  }}
    <a class="layui-btn  layui-btn-normal layui-btn-xs" lay-event="select"><i class="layui-icon">&#xe616;</i>设为默认</a>
    {{# } }}
...
<script type="text/html" id="statusOption">
    ...
    {{# } else{  }}
    <span class="layui-badge layui-bg-cyan">非默认</span>
    {{# } }}
</script>
...
<script src="${pageContext.request.contextPath}/js/sys/mail/sys_mail_template.js"></script>
</body>
</html>
