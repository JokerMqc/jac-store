            ...
            <form class="layui-form" action="">
                <div class="layui-form-item form-item-ex">
                    <div class="layui-inline ">
                        <label class="layui-form-label form-label-ex-4">字典名称:</label>
                        <div class="layui-input-inline input-line-ex">
                            <input type="text"  id="searchName" name="name" placeholder="输入字典名称搜索" autocomplete="off"
...
<script src="${pageContext.request.contextPath}/js/sys/dict/sys_dict_type_list.js"></script>
</body>
</html>
