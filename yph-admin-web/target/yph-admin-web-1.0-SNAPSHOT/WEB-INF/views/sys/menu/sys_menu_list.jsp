...
<head>
    ...
    <%--ztree 插件--%>
    <link rel="stylesheet"
          href="${pageContext.request.contextPath}/js/plugins/ztree/assets/font-awesome/css/font-awesome.min.css">
...
<div id="content" style="width:100%;height: 100%;padding:0;margin: 0;">
    ...
    <div style="float: left;width: 100%;height:90%;margin-left: 260px;">
        ...
        <blockquote id="buttonQuoto" style="margin-top: 5px;" class="layui-elem-quote elem-quote-ex">
            ...
            <button style="margin-left: 10px; " class="layui-btn layui-btn-danger layui-btn-sm"
                    onclick="batchDelMenus()">
...
<div id="createMenuWindow" hidden="hidden">
    ...
    <fieldset class="layui-elem-field" style="width: 830px;margin-left: 8px;">
        ...
        <div class="layui-field-box">
            <form class="layui-form" id="createForm" action="">

                <div id="eidtDiv" class="layui-form-item form-item-ex">
                    <div class="layui-row">
                        <div class="layui-col-xs6">
                            <label class="layui-form-label form-label-ex-4">上级菜单:</label>
                            <div class="layui-input-inline form-input-line-ex">
                                <input type="text" id="parentName" name="parentName" readonly autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>

                        <div class="layui-col-xs6">
                            <label class="layui-form-label form-label-ex-4">是否同级:</label>
                            <div class="layui-input-block form-input-line-ex">
                                <input type="checkbox" id="selectType" name="selectType" title="是">
                            </div>
                        </div>
                ...
                <div class="layui-form-item form-item-ex">
                    ...
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs6">
                            <label class="layui-form-label form-label-ex-4">上级Id:</label>
                            <div class="layui-input-inline form-input-line-ex">
                                <input type="number" id="parentId" name="parentId" readonly autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-form-item form-item-ex">
                    <div class="layui-row">
                        ...
                        <div class="layui-col-xs6">
                            <label class="layui-form-label form-label-ex-4">图标:</label>
                            <div class="layui-input-inline form-input-line-ex">
                                <input type="text" id="icon" name="icon" placeholder="输入样式名称即可啦!比如: fa fa-list-ul "
                        ...
                        <div class="layui-col-xs6">
                            ...
                            <div class="layui-input-inline form-input-line-ex">
                                <input type="number" id="sort" name="sort" lay-verify="required" autocomplete="off"
                                       class="layui-input">
                            </div>
                        </div>
                    </div>
                ...
                <hr class="layui-bg-gray" style="margin: 6px">
                ...
                <input type="text" id="type" name="type" value="" hidden="hidden">
                <input type="text" id="id" name="id" value="" hidden="hidden" style="display: none;">
            </form>
        </div>
    </fieldset>
</div>
...
<script src="${pageContext.request.contextPath}/js/sys/menu/sys_menu_list.js"></script>
</body>
</html>
