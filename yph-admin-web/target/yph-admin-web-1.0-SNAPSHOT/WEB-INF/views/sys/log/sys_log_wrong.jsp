...
<div id="content" style="height: 100%;padding:0;margin: 0;overflow: hidden;">
    ...
    <%--搜索--%>
    <blockquote style="margin-top: 5px;" class="layui-elem-quote elem-quote-ex">
    ...
    <%--数据表格--%>
    <table class="layui-hide" id="tableElem" lay-data="{id: 'tableId'}" lay-filter="tableFilter"></table>
...
<script src="${pageContext.request.contextPath}/js/sys/log/sys_log_wrong.js"></script>
</body>
</html>
