...
<div id="content" style="height: 100%;padding:0;margin: 0;overflow: hidden;">
        ...
        <form class="layui-form" action="">
            <div class="layui-form-item form-item-ex">
                <div class="layui-inline ">
                    <label class="layui-form-label form-label-ex-4">用户名称:</label>
                    <div class="layui-input-inline input-line-ex">
                        <input type="text" id="searchName" name="roleName" placeholder="输入用户名称搜索" autocomplete="off"
    ...
    <blockquote id="buttonQuoto" style="margin-top: 5px;" class="layui-elem-quote elem-quote-ex">
        <button style="margin-left: 10px;" class="layui-btn layui-btn-sm" onclick="openCreateWindow()"><i class="layui-icon">&#xe608;</i>新增用户
        </button>
    ...
    <%--数据表格--%>
    <table class="layui-hide" id="layUserRole" lay-data="{id: 'idUserRole'}" lay-filter="tableFilter"></table>
    ...
    <div id="createWindow" hidden="hidden" style="overflow: hidden">
        ...
        <fieldset class="layui-elem-field" style="width: 830px;margin-left: 8px;">
            <legend style="margin: 0px;padding: 0px;">填写用户信息</legend>
...
<script src="${pageContext.request.contextPath}/js/sys/user/sys_user_list.js"></script>
</body>
</html>
