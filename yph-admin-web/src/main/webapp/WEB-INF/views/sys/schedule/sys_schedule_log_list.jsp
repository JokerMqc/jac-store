            ...
            <div class="layui-form-item form-item-ex">
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-inline input-line-ex">
                        <input type="text" id="searchName" name="roleName" placeholder="输入任务名称搜索" autocomplete="off"
...
<script type="text/html" id="statusOption">
    <%--{{# if(d.status=='0'){   }}--%>
    <%--<span class="layui-badge layui-bg-blue">成功执行</span>--%>
    <%--{{# } else{  }}--%>
    <%--<span class="layui-badge layui-bg-cyan">执行失败</span>--%>
    <%--{{# } }}--%>
</script>
...
<script src="${pageContext.request.contextPath}/js/sys/schedule/sys_schedule_log_list.js"></script>
</body>
</html>
