...
public class SysMenuController {
    ...
    public CommonResult findMenuListByPage(@RequestParam HashMap<String, Object> params, Integer pageNum, Integer pageSize) {
     ...
     */
    @ResponseBody
    @RequestMapping("findAllListByZtree")
    public CommonResult findAllListByZtree(@RequestParam HashMap<String, Object> params){
        List<ZtreeVo> allListByZtree = sysMenuService.findAllListByZtree(params);
        return CommonResult.SUCCESS(allListByZtree);
    }
