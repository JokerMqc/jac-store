...
public class SysRoleMenuController {
     ...
     */
    @ResponseBody
    @RequestMapping("findAllMenuByZtree")
    public CommonResult findAllMenuByZtree(@RequestParam HashMap<String,Object> params){
        List<ZtreeVo> roleAllMenuList = sysRoleMenuService.findRoleAllMenuList(params);
        return CommonResult.SUCCESS(roleAllMenuList);
    }
