...
public class SysRoleMenuServiceImpl implements ISysRoleMenuService{
    ...
    public List<ZtreeVo> findRoleAllMenuList(HashMap<String,Object> params) {
        List<ZtreeVo> list = sysMenuService.findAllListByZtree(params);
        return list ;
    }
     ...
     */
    @Override
    @RedisEvict(type = SysRoleMenu.class,evicts = {"SysMenuServiceImpl"})
